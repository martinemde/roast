  ...
  module Workflow
    class StepNameExtractorTest < ActiveSupport::TestCase
      ...
      test "truncates long command steps" do
        ...
        assert_equal "echo 'this is a ver...", @extractor.extract(long_command, StepTypeResolver::COMMAND_STEP)
      end
      ...
      test "truncates inline prompt without label" do
        ...
        assert_equal "Analyze this text...", @extractor.extract(step, StepTypeResolver::HASH_STEP)
      end
      ...
      test "handles multi-line inline prompts by using first non-empty line" do
        ...
        assert_equal "Provide a detailed...", @extractor.extract(step, StepTypeResolver::HASH_STEP)
      end
