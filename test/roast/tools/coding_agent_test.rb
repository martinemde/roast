  ...
  module Tools
    class CodingAgentTest < ActiveSupport::TestCase
      ...
      test "included method registers coding_agent function" do
        ...
        assert_equal "AI-powered coding agent that runs an instance of the Claude Code agent with the given prompt. If the agent is iterating on previous work, set continue to true. To resume from a specific previous session, set resume to the step name. Note: resume takes precedence over continue if both are specified.", function_def[:description]
