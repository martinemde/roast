...
module Roast
  module Workflow
    ...
    class Configuration
      ...
      attr_reader :config_hash, :workflow_path, :name, :steps, :pre_processing, :post_processing, :tools, :tool_configs, :mcp_tools, :function_configs, :model, :resource, :context_management, :retry_config
      ...
      def initialize(workflow_path, options = {})
        ...
        @retry_config = ConfigurationLoader.extract_retry_config(@config_hash)
